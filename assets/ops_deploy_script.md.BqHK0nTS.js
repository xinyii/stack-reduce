import{_ as s,c as i,o as a,a1 as n}from"./chunks/framework.fM52Fl5S.js";const y=JSON.parse('{"title":"Script","description":"","frontmatter":{},"headers":[],"relativePath":"ops/deploy/script.md","filePath":"ops/deploy/script.md","lastUpdated":1716529767000}'),p={name:"ops/deploy/script.md"},h=n(`<h1 id="script" tabindex="-1">Script <a class="header-anchor" href="#script" aria-label="Permalink to &quot;Script&quot;">​</a></h1><h2 id="java-独立程序启停脚本" tabindex="-1">Java 独立程序启停脚本 <a class="header-anchor" href="#java-独立程序启停脚本" aria-label="Permalink to &quot;Java 独立程序启停脚本&quot;">​</a></h2><p>支持命令</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">./myapp.sh</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> start</span></span>
